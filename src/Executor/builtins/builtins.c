...
int	execute_builtin(t_cmd *cmd, t_minishell *minishell)
{
	if (!(cmd && cmd->cmd_arr && cmd->cmd_arr[0]))
		return (0);
	if (ft_strcmp(cmd->cmd_arr[0], "echo") == 0 || ft_strcmp(cmd->cmd_arr[0], "/bin/echo") == 0)
		execute_echo(cmd);
	else if (ft_strcmp(cmd->cmd_arr[0], "cd") == 0 || ft_strcmp(cmd->cmd_arr[0], "/usr/bin/cd") == 0)
		return (execute_cd(cmd));
	else if (ft_strcmp(cmd->cmd_arr[0], "pwd") == 0 || ft_strcmp(cmd->cmd_arr[0], "/bin/pwd") == 0)
		return (execute_pwd());
	...
	else if (ft_strcmp(cmd->cmd_arr[0], "env") == 0 || ft_strcmp(cmd->cmd_arr[0], "/usr/bin/env") == 0 || ft_strcmp(cmd->cmd_arr[0], "ENV") == 0)
...
int	is_builtin(t_cmd *cmd)
{
	...
	(ft_strcmp(cmd->cmd_arr[0], "/bin/echo") == 0) || 
